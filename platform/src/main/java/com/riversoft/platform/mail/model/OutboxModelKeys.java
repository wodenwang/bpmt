 ...
 * 
 */
public enum OutboxModelKeys implements ModelKey {
	 ...
	 * 
	 */
	SENT_DATE("发送时间", false, false, false, Types.TIMESTAMP, 0, 0),
	/**
	 * 
	 */
	...
	private OutboxModelKeys(String description, boolean primaryKey, boolean autoIncrement, boolean required,
