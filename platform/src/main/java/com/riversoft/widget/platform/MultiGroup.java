 ...
 * 
 */
@WidgetAnnotation(cmd = "multigroup", ftl = "classpath:widget/{mode}/platform/multigroup.ftl")
public class MultiGroup extends Group {
	...
	public String show(Object value) {
		...
		for (String val : vals) {
			// 遍历翻译
			array.add((String) Code2NameService.getInstance().translateORM(UsGroup.class.getName(), "groupKey",
					"busiName", val));
		}
