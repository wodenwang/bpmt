package com.riversoft.wx.mp.builder;
...
public class PayRequestBuilder {
	...
	public static UnifiedOrderRequest buildUnifiedOrderRequest(String mchId, Map<String, Object> map) {
		...
		if (map.containsKey("product")) {
			...
			unifiedOrderRequest.setProductId(mchId + Formatter.formatDatetime(new Date(), "yyyyMMddHHmmssSSS") + new Random().nextInt(10));
		}
		...
		// 必要验证
		if ("JSAPI".equalsIgnoreCase(unifiedOrderRequest.getTradeType()) && StringUtils.isEmpty(unifiedOrderRequest.getOpenId())) {
