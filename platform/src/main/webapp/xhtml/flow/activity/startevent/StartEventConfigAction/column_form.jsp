...
<div accordion="true" multi="true">
	<div title="表单">
		<table class="ws-table">
			...
			<tr>
				<th>控件动态入参(脚本)<br /> <font color="red" tip="true" title="新增时无法使用vo.返回字符串,在自定义控件中在request中通过[_params]命令字获取.">(提示)</font></th>
			...
			<tr>
				<th>表单内容(脚本内容)<br /> <font color="red" tip="true" title="新增时无法使用vo.">(提示)</font></th>
			...
			<tr>
				<th>填写提示(脚本)<br /> <font color="red" tip="true" title="新增时无法使用vo.">(提示)</font></th>
	...
	<div title="条件">
		<table class="ws-table">
			...
			<tr>
				<th>可编辑条件(脚本)<br /> <font color="red" tip="true" title="新增时有效,无法使用vo.">(提示)</font></th>
