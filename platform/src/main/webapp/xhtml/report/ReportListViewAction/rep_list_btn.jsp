						...
						<c:choose>
							...
							<c:when test="${vo.name=='show'}">
								...
								<table class="ws-table">
									...
									<tr>
										<th>唯一键传值(类型)</th>
										<td><wcm:widget name="config.pkType" cmd="select[@com.riversoft.platform.script.ScriptTypes]" value="${config.pkType}" /></td>
									</tr>
									<tr>
										<th>唯一键传值(脚本)<br /> <font color="red" title="vo:查询到的一条记录;留空则界面不展示[明细查看]按钮." tip="true">(提示)</font></th>
										<td><wcm:widget name="config.pkScript" cmd="codemirror[groovy]" value="${config.pkScript}" /></td>
									</tr>
									<tr>
										<th>唯一键SQL片段(类型)</th>
										<td><wcm:widget name="config.pkSqlType" cmd="select[@com.riversoft.platform.script.ScriptTypes]" value="${config.pkSqlType}" /></td>
									</tr>
									<tr>
										<th>唯一键SQL片段(脚本)<br /> <font color="red" title="value:唯一键传递值;" tip="true">(提示)</font></th>
										<td><wcm:widget name="config.pkSqlScript" cmd="codemirror[groovy]" value="${config.pkSqlScript}" /></td>
									</tr>
									<tr>
										<th>备注</th>
									...
									<tr>
										<th>功能点</th>
										<td><wcm:widget name="${pixel}.pri" cmd="pri[vo:实体]{required:true}" value="${vo.pri}"></wcm:widget></td>
									</tr>
								</table>
							</c:when>
							<%-- 自定义按钮 --%>
