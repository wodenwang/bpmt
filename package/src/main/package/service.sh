...
COMMON_DIR=${INSTALLATION_DIR}/common
TOMCAT_HOME=${COMMON_DIR}/tomcat
RIVER_CATALINA_BASE=${COMMON_DIR}/CATALINA_BASE

. ${INSTALLATION_DIR}/common/set_env.sh

export CATALINA_HOME=${TOMCAT_HOME}
export CATALINA_BASE=${RIVER_CATALINA_BASE}
