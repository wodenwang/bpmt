...
:USINGBUILTIN
if exist %THISDIR%\jdk\win32 set JAVA_HOME=%THISDIR%\jdk\win32
if exist %THISDIR%\jdk\win64 set JAVA_HOME=%THISDIR%\jdk\win64

:SETANT
if "%ANT_HOME%" == "" (
	set ANT_HOME=%THISDIR%\ant
)

set ANT_OPTS="-Djava.library.path=%THISDIR%\native-libs -Xms256m -Xmx1024m"
