...
echo -ne "${FONTCOLOR}************************ 数据导出工具 *********************${END}\n"
echo -ne 			 "*********************************************************\n"

ANT=${ANT_HOME}/bin/ant

${ANT} -buildfile ${RIVER_TOOLS_INTERNAL_DIR}/ant/dbexport.xml -lib ${RIVER_TOOLS_INTERNAL_DIR}/libs -logger com.riversoft.dtask.BuildLogger -q 
