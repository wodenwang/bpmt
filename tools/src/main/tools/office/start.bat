...
call %ANT% -Doffice-command=start -buildfile %RIVER_TOOLS_INTERNAL_DIR%\ant\office.xml -lib %RIVER_TOOLS_INTERNAL_DIR%\libs -logger com.riversoft.dtask.BuildLogger -q 
