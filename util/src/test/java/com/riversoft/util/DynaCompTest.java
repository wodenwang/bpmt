...
import com.riversoft.util.dynamicbean.CharSequenceJavaFileObject;
import com.riversoft.util.dynamicbean.ClassFileManager;

public class DynaCompTest {
    public static void main(String[] args) throws Exception {
        // Full name of the class that will be compiled. If class should be in some package, fullName should contain it
        // too (ex. "testpackage.DynaClass")
