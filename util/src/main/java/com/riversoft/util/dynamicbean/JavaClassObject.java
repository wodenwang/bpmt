...
public class JavaClassObject extends SimpleJavaFileObject {
    ...
    /**
     * Will provide the compiler with an output stream that leads to our byte array. This way the compiler will write
     * everything into the byte array that we will instantiate later
     */
    @Override
